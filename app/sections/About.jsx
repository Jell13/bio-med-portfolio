...
const About = () => {
    ...
    return (
        <section
            id="about"
            className="relative py-32 px-6 font-dmsans lg:px-20 bg-white overflow-hidden"
        >
            {/* Decorative Elements */}
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 font-dmsans">
                        ...
                        <div className="space-y-6">
                            <h3 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight font-albert text-[#214970]">
                                Building quality systems that ensure product
                                excellence
                            </h3>
                            <p className="text-gray-700 leading-relaxed">
                                As a bioengineer transitioning into quality
                                assurance, I bring a unique perspective that
                                combines rigorous scientific methodology with a
                                passion for process optimization. My research
                                background has instilled in me the importance of
                                documentation, reproducibility, and
                                compliance—core principles that drive effective
                                quality management.
                            </p>
                            <p className="text-gray-700 leading-relaxed">
                                Through hands-on experience in laboratory
                                settings, I've developed expertise in
                                standardizing protocols, performing root-cause
                                analysis, and implementing corrective actions.
                                I'm driven by the opportunity to ensure products
