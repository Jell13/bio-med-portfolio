    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-20 py-5 flex items-center justify-between">
        ...
        >
          ...
          <motion.span
            className="absolute inset-0 bg-[#E8A87C]/20 rounded-lg blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          />
        </motion.a>
        ...
        <div className="hidden md:flex items-center gap-10">
          {navItems.map((item, index) => (
            ...
            >
              ...
              <motion.span
                className="absolute bottom-0 left-0 w-0 h-[2px] bg-[#E8A87C] group-hover:w-full transition-all duration-300"
              />
              <motion.span
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden bg-[#214970]/95 backdrop-blur-md border-t border-white/10 overflow-hidden"
          >
